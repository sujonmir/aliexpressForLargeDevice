...
(function(window){
    ...
    function lignePaginate(){
        ...
        var pageButtons = function(numberOfPage,currentPage) {
             ...
             **/
            let buttons = "<input type='button' value=' < Previuos' class='paginate_control_prev' onclick='paginate.sort("+(currentPage - 1)+")' "+prevDisabled+">";
            let buttonNumberOfPage = "<span > Total " + numberOfPage + ' pages ' + ' ' + 'Go to page' + "</span>";
        ...
        var paginationMoreThatTenPage = function(iterator,numberOfPage){
            ...
            if(iterator > referenceForTheLast || iterator < 8){
        ...
        var addGoToPage = function(){
            let inputBox = "<input type='text' id='paginate_page_to_go'  min='1' max='"+ settings.numberOfPages +"'>";
